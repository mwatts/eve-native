...
fn file_error(changes: &mut Vec<RawChange>, id: String, why: Error) {
    ...
    changes.push(RawChange {
        ...
        v: Internable::String("file/error".to_string()),
        n: Internable::String("file/error".to_string()),
        count: 1,
    });
    changes.push(RawChange {
        e: err_id.clone(),
        a: Internable::String("message".to_string()),
        v: Internable::String(why.to_string()),
        n: Internable::String("file/error".to_string()),
        count: 1,
    });
    changes.push(RawChange {
        e: err_id.clone(),
        a: Internable::String("file".to_string()),
        v: Internable::String(id.to_string()),
        n: Internable::String("file/error".to_string()),
        count: 1,
    });
}
                            ...
                            match file.read_to_string(&mut contents) {
                                ...
                                Ok(_) => {
                                    changes.push(RawChange {
                                        e: id.clone(),
                                        a: Internable::String("tag".to_string()),
                                        v: Internable::String("file/read/change".to_string()),
                                        n: Internable::String("file/read".to_string()),
                                        count: 1,
                                    });
                                    changes.push(RawChange {
                                        e: id.clone(),
                                        a: Internable::String("file".to_string()),
                                        v: Internable::String(record_id.to_string()),
                                        n: Internable::String("file/read".to_string()),
                                        count: 1,
                                    });
                                    changes.push(RawChange {
                                        e: id.clone(),
                                        a: Internable::String("contents".to_string()),
                                        v: Internable::String(contents.clone()),
                                        n: Internable::String("file/read".to_string()),
                                        count: 1,
                                    });
                                }
