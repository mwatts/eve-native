...
fn distinct_anti_no_join() {
    test_anti_distinct(vec![(1, 1), (3, -1)], vec![], vec![(1, 1), (3, -1)]);
}
...
fn distinct_anti_simple_no_return_multi() {
    test_anti_distinct(vec![(1, 1), (2, 1), (3, -2)], vec![(1, 1), (5, -1)], vec![]);
}

#[test]
fn distinct_anti_simple_retraction() {
    test_anti_distinct(vec![(1, 1), (2, 1)], vec![(3, 1)], vec![(1, 1), (3, -1)]);
}
...
fn distinct_anti_simple_retraction_same_end() {
    test_anti_distinct(vec![(1, 1), (6, -1)], vec![(1, 1), (6, -1)], vec![]);
}
