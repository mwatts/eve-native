...
fn make_faculty(
    program: &mut Program,
    eavs: &mut Vec<(u32, u32, u32)>,
    university_count: usize,
    department: &str,
    cur_type: &str,
    ix: u32,
    publications: u32,
    ...
    for university_ix in 0..university_count {
        ...
        for department_ix in 0..department_count {
            ...
            for ug_ix in 0..undergrads_count {
                ...
                // 1/5 of the UndergraduateStudents have a Professor as their advisor
                if ug_ix % 5 == 0 {
                    let prof = random_professor(
                        &mut seed,
                        &department,
                        full_professors_count,
                        associate_professors_count,
                        assistant_professors_count,
                    );
...
#[bench]
pub fn do_lubm_1(b: &mut Bencher) {
    do_bench(b, "lubm1", lubm_1);
}
#[bench]
pub fn do_lubm_2(b: &mut Bencher) {
    do_bench(b, "lubm2", lubm_2);
}
#[bench]
pub fn do_lubm_3(b: &mut Bencher) {
    do_bench(b, "lubm3", lubm_3);
}
#[bench]
pub fn do_lubm_4(b: &mut Bencher) {
    do_bench(b, "lubm4", lubm_4);
}
#[bench]
pub fn do_lubm_5(b: &mut Bencher) {
    do_bench(b, "lubm5", lubm_5);
}
#[bench]
pub fn do_lubm_7(b: &mut Bencher) {
    do_bench(b, "lubm7", lubm_7);
}
#[bench]
pub fn do_lubm_8(b: &mut Bencher) {
    do_bench(b, "lubm8", lubm_8);
}
#[bench]
pub fn do_lubm_9(b: &mut Bencher) {
    do_bench(b, "lubm9", lubm_9);
}
#[bench]
pub fn do_lubm_11(b: &mut Bencher) {
    do_bench(b, "lubm11", lubm_11);
}
#[bench]
pub fn do_lubm_12(b: &mut Bencher) {
    do_bench(b, "lubm12", lubm_12);
}
#[bench]
pub fn do_lubm_13(b: &mut Bencher) {
    do_bench(b, "lubm13", lubm_13);
}
#[bench]
pub fn do_lubm_14(b: &mut Bencher) {
    do_bench(b, "lubm14", lubm_14);
}
